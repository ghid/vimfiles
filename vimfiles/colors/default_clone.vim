...
" Last Updated: 18.09.2019 08:15:58
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if &background ==# 'dark'
    ...
    hi Comment guifg=#80a0ff guibg=NONE guisp=NONE gui=italic cterm=italic
  ...
  hi WarningMsg guifg=Red guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=Black guibg=Yellow guisp=NONE gui=NONE cterm=NONE
  hi Comment guifg=Blue guibg=Yellow guisp=NONE gui=underline cterm=underline
...
if s:t_Co >= 256
  ...
  hi WildMenu ctermbg=11 cterm=NONE
  hi Comment ctermfg=4 ctermbg=11 cterm=underline
...
if s:t_Co >= 8
  if &background ==# 'dark'
    ...
    hi Comment ctermfg=Cyan ctermbg=NONE cterm=italic
  ...
  hi WildMenu ctermfg=Black ctermbg=Yellow cterm=NONE
  hi Comment ctermfg=DarkBlue ctermbg=Yellow cterm=underline
